...
BOT_TOKEN = environ.get('BOT_TOKEN', '8776818362:AAFCH07oSCy70vOpP42sBwvt5mV3Pt0eyG0')
PORT = environ.get('PORT', '8082')

# Owners 
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8219927344').split()]
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'Team_Tigerss) # without @ or https://t.me/ 
...
AUTH_CHANNEL = int(environ.get('AUTH_CHANNEL', '-1003795699526'))
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL', '-1003949493013'))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003780029097'))
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1003780029097')) 
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1003780029097'))

# MongoDB 
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://botss:botss@cluster0.u0imb.mongodb.net/?appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")

# Files index database url
FILES_DATABASE = environ.get('FILES_DATABASE', "-1003489058284")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', https://t.me/+vCAVcM3ahdlhM2Q9'')
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+vCAVcM3ahdlhM2Q9')
